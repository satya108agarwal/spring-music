...
/**
 * Configuration class for setting up Redis in a Spring application.
 * This configuration is activated only when the "redis" profile is active.
 */
@Configuration
@Profile("redis")
public class RedisConfig {
    ...
    /**
     * Configures a RedisTemplate bean for performing Redis operations with Album objects.
     *
